...
[![Stable](https://img.shields.io/badge/docs-stable-blue.svg)](https://ohno.github.io/MyPkg50.jl/stable/)
[![Dev](https://img.shields.io/badge/docs-dev-blue.svg)](https://ohno.github.io/MyPkg50.jl/dev/)
...
```julia
julia> import Pkg; Pkg.add(url="https://github.com/ohno/MyPkg50.jl.git")
```
...
Feature requests and bug reports are handled through GitHub [Issues](https://github.com/ohno/MyPkg50.jl/issues).
...
[CITATION.bib](https://github.com/ohno/MyPkg50.jl/blob/main/CITATION.bib) is available for citing this package.
...
This package is released under the [MIT License](https://github.com/ohno/MyPkg50.jl/blob/main/LICENSE).
