...
Clone the [repository](https://github.com/ohno/MyPkg50.jl) and install development tools, [Revise.jl](https://github.com/timholy/Revise.jl) and [Runic.jl](https://github.com/fredrikekre/Runic.jl).
...
- [Project.toml](https://github.com/ohno/MyPkg50.jl/blob/main/Project.toml#L4)
- [CITATION.bib](https://github.com/ohno/MyPkg50.jl/blob/main/CITATION.bib#5)
